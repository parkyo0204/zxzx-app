// Shared file dropzone UX — drag/drop, preview, remove, progress
// Used by compress.ts, convert.ts, resize.ts
...
export class FileDropzone {
  ...
  private options: Required<FileDropzoneOptions>;
...
// Standalone format size utility
...
export class ProgressBar {
  ...
  constructor(insertAfterId: string) {
